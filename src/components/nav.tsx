...
export default function Nav({ position }: { position: "top" | "bottom" }) {
  return (
    <nav className={`flex shadow-[0px_2px_4px_0px_#0000000D] flex-col border dark:border-zinc-600 rounded-lg *:rounded-lg bg-white dark:bg-[#211f25] *:py-2 *:transition-colors
